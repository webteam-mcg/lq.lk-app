...
import 'package:lq_live_app/models/data_model.dart';
import 'package:lq_live_app/models/functions_model.dart';

var bats = <DataBat>[
  DataBat(name: 'Rusiru Anupama', runs: 1, balls: 2, fours: 3, sixes: 4, rs: 5),
];
var balls = <DataBall>[
  DataBall(name: 'Rusiru Anupama', balls: 13, m: 3, r: 31, w: 3, econ: '2.72')
];
                                ...
                                DataTable(
                                    ...
                                    rows: bats
                                        .map((bat) => DataRow(cells: [
                                              ...
                                              DataCell(
                                                  Text(bat.runs.toString())),
                                              DataCell(
                                                  Text(bat.balls.toString())),
                                              DataCell(
                                                  Text(bat.fours.toString())),
                                              DataCell(
                                                  Text(bat.sixes.toString())),
